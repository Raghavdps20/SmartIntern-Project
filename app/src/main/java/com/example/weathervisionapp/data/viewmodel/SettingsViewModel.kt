...
class SettingsViewModel @Inject constructor(
    ...
    fun selectedCity(index: Int):String {
        return when (index) {
            0 -> context.getString(R.string.mumbai)
            1 -> context.getString(R.string.delhi)
            2 -> context.getString(R.string.bangalore)
            3 -> context.getString(R.string.hyderabad)
            4 -> context.getString(R.string.ahmedabad)
            5 -> context.getString(R.string.chennai)
            6 -> context.getString(R.string.kolkata)
