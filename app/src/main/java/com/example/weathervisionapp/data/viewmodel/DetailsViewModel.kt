...
import com.example.weathervisionapp.data.model.pollution.AirPollutionResponse
import com.example.weathervisionapp.data.network.Resource
import com.example.weathervisionapp.data.repository.DetailsRepo
...
class DetailsViewModel @Inject constructor(
    ...
    private val _currentPollution = MutableStateFlow<Resource<AirPollutionResponse>>(
        Resource.Idle)
